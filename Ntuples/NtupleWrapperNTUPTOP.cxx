#include "NtupleWrapperNTUPTOP.h"

NtupleWrapperNTUPTOP::NtupleWrapperNTUPTOP( const char * fileListName, const char * branchListName, const char * treeName ) : 
  NtupleWrapper< NTUPTOP >( fileListName, branchListName, treeName )
{
}
...
NtupleWrapperNTUPTOP::~NtupleWrapperNTUPTOP()
{
...
bool NtupleWrapperNTUPTOP::MakeEventInfo( EventData * ed )
{
  bool success = true;
...
bool NtupleWrapperNTUPTOP::MakeEventMET( EventData * ed )
{
  bool success = true;
...
bool NtupleWrapperNTUPTOP::MakeEventElectrons( EventData * ed )
{
  bool success = true;
...
bool NtupleWrapperNTUPTOP::MakeEventMuons( EventData * ed )
{
  bool success = true;
...
bool NtupleWrapperNTUPTOP::MakeEventJets( EventData * ed )
{
  bool success = true;
...
bool NtupleWrapperNTUPTOP::MakeEventTruth( EventData * ed )
{
  bool success = true;
...
extern "C" {
  NtupleWrapperPluginFactory_NTUPTOP * MakeNtupleWrapperPlugin() {
    return new NtupleWrapperPluginFactory_NTUPTOP( "NTUPTOP" );
  };
}
