...
public :
   ...
   Float_t         parton_topQuark_eta[10];   //[parton_topQuark_n]
   Float_t         parton_topQuark_phi[10];   //[parton_topQuark_n]
   Int_t           parton_topQuark_status[10];   //[parton_topQuark_n]
   Int_t           parton_topQuark_isHadronic[10];   //[parton_topQuark_n]
   Int_t           parton_topQuark_pdgId[10];   //[parton_topQuark_n]
   Int_t           parton_bQuark_n;
   Float_t         parton_bQuark_m[10];   //[parton_bQuark_n]
   Float_t         parton_bQuark_pt[10];   //[parton_bQuark_n]
   Float_t         parton_bQuark_eta[10];   //[parton_bQuark_n]
   Float_t         parton_bQuark_phi[10];   //[parton_bQuark_n]
   Bool_t          parton_bQuark_from_top[10];   //[parton_bQuark_n]
   Int_t           parton_bQuark_status[10];   //[parton_bQuark_n]
   Int_t           parton_bQuark_pdgId[10];   //[parton_bQuark_n]
   Int_t           parton_cQuark_n;
   Float_t         parton_cQuark_m[15];   //[parton_cQuark_n]
   Float_t         parton_cQuark_pt[15];   //[parton_cQuark_n]
   Float_t         parton_cQuark_eta[15];   //[parton_cQuark_n]
   Float_t         parton_cQuark_phi[15];   //[parton_cQuark_n]
   Bool_t          parton_cQuark_from_top[15];   //[parton_cQuark_n]
   Int_t           parton_cQuark_status[15];   //[parton_cQuark_n]
   Int_t           parton_cQuark_pdgId[15];   //[parton_cQuark_n]
   Int_t           parton_Wboson_n;
   Float_t         parton_Wboson_m[10];   //[parton_Wboson_n]
   Float_t         parton_Wboson_pt[10];   //[parton_Wboson_n]
   Float_t         parton_Wboson_eta[10];   //[parton_Wboson_n]
   Float_t         parton_Wboson_phi[10];   //[parton_Wboson_n]
   Bool_t          parton_Wboson_from_top[10];   //[parton_Wboson_n]
   Int_t           parton_Wboson_status[10];   //[parton_Wboson_n]
   Int_t           parton_Wboson_isHadronic[10];   //[parton_Wboson_n]
   Int_t           parton_Wboson_pdgId[10];   //[parton_Wboson_n]
