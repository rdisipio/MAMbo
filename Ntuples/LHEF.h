...
// Mon Jan 26 13:12:49 2015 by ROOT version 5.34/25
// from TTree LHEF/Analysis tree
// found on file: /scratch/r/rorr/disipio/ntuples/ttH/pp_ttH_HWW.powhegboxv2.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/scratch/r/rorr/disipio/ntuples/ttH/pp_ttH_HWW.powhegboxv2.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/scratch/r/rorr/disipio/ntuples/ttH/pp_ttH_HWW.powhegboxv2.root");
      }
