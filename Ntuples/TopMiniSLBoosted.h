...
#ifndef TopMiniSLBoosted_h
#define TopMiniSLBoosted_h
...
public :
   ...
   TopMiniSLBoosted(TTree *tree=0);
   virtual ~TopMiniSLBoosted();
...
#ifdef TopMiniSLBoosted_cxx
TopMiniSLBoosted::TopMiniSLBoosted(TTree *tree) : fChain(0) 
{
...
TopMiniSLBoosted::~TopMiniSLBoosted()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TopMiniSLBoosted::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TopMiniSLBoosted::LoadTree(Long64_t entry)
{
...
void TopMiniSLBoosted::Init(TTree *tree)
{
...
Bool_t TopMiniSLBoosted::Notify()
{
...
void TopMiniSLBoosted::Show(Long64_t entry)
{
...
Int_t TopMiniSLBoosted::Cut(Long64_t entry)
{
...
#endif // #ifdef TopMiniSLBoosted_cxx
