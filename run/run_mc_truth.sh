...
echo runMAMbo -p control/analysis_params/TTbarResolved_resolved/mcparticles_${ll}_JK.xml -f lists/list_eos_new_mc.txt -o histograms_PowHeg_${ll}_particle_NewWhad.root 
