...
def CreateMergedHistograms( errorsf, outputClass = OutputType.graph ):
...
#       DumpSystematicsToXMLFile( hpath, edges, points, total_uncertainty )
       ...
       for i in range(nbins):
          ...
          graph.SetPointError( i, bw/2, bw/2, errorsf * eyl, errorsf * eyh )
...
if __name__ == "__main__":
   ...
   CreateMergedHistograms(float(opts.errorsf))
