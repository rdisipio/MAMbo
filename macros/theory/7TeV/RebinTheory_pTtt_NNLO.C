...
// main usage: 
// root -l -b -q 'RebinTheory_pTtt_NNLO.C+("data/pTtt_7000.dat", 0, false, 1, "recreate")'
...
TH1D *RebinTheory_pTtt_NNLO(TString inputName = "data/pTtt_7000_pTtt_fin.dat", int ResultToUse = -1, bool Draw = true, int debug = 2, TString fopt = "recreate" ) 
{
  ...
  // ATLAS
   ...
   double xbins[numXbins] = { 0, 40, 170, 340, 1000. };
